...
class SINRMap:
    ...
    def __init__(
        ...
        self._best_bs: Dict[tuple[int, int], EntityID] = {}
        self.grid = None
    ...
    def update_best_bs_loc(self, l: Location, bs_id: EntityID) -> None:
        self._loc_wrap(l, self.update_best_bs, bs_id)

    def get_best_bs_loc(self, l: Location) -> Optional[EntityID]:
        return self._loc_wrap(l, self.get_best_bs)
    ...
    def update_best_bs(self, x: int, y: int, bs_id: EntityID) -> None:
        self._best_bs[(x,y)] = bs_id

    def get_best_bs(self, x: int, y: int) -> Optional[EntityID]:
        return self._best_bs.get((x,y))
