...
class MapGrid:
    ...
    @classmethod
    def fromMap(cls, map, gridRows, movableCollectionsSet) -> "MapGrid":
        return cls(
            map.radius * 2,
            gridRows,
            movableCollectionsSet,
            map.latitudeInterval[0],
            map.latitudeInterval[1],
            map.longitudeInterval[0],
            map.longitudeInterval[1],
        )
